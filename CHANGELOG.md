...
- Fixed electron-builder not including desktop-init.sh bug [electron-userland/electron-builder#10002](https://github.com/electron-userland/electron-builder/issues/10002)
